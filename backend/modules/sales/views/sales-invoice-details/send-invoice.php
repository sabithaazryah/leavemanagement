...
<div id="print">
    ...
    <table class="main-tabl" border="0" style="font-family: Roboto, sans-serif !important;width: 100%;border: 1px solid #928f8f;padding: 15px;">
        <thead>
            <tr>
                <th style="width:100%">
                    <div class="header">
        ...
        <tbody>
            <tr>
                <td>
                    <div class="heading"><h2 style="font-size:17px;letter-spacing: 4px;padding-top: 10px;text-align: center;">TAX INVOICE</h2></div>
                    <br/>
