...
class SupplierController extends \yii\web\Controller {
    ...
    public function actionCreate() {
        ...
        if ($model->load(Yii::$app->request->post()) && Yii::$app->SetValues->Attributes($model) && $model->validate() && $model->save()) {
            Yii::$app->getSession()->setFlash('success', 'New Supplier Added Successfully');
    ...
    public function actionUpdate($id) {
        ...
        if ($model->load(Yii::$app->request->post()) && Yii::$app->SetValues->Attributes($model) && $model->validate() && $model->save()) {
            Yii::$app->getSession()->setFlash('success', 'Supplier Updated Successfully');
            return $this->redirect(['index']);
    ...
    public function actionDel($id) {
        ...
        if ($model->delete()) {
            Yii::$app->getSession()->setFlash('success', 'Supplier Removed Successfully');
        }
