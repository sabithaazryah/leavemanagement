...
/* @var $searchModel common\models\WorkingHoursSearch */
        ...
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?= Html::button('<i class="fa-th-list"></i><span> Add Working Hours</span>', ['value' => Url::to('create'), 'class' => 'btn btn-warning  btn-icon btn-icon-standalone modalButton']) ?>
