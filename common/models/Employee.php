...
class Employee extends ActiveRecord implements IdentityInterface {
        ...
        public function rules() {
                return [
                        [['user_name', 'password', 'name', 'email', 'branch', 'department', 'designation', 'recommender', 'approver', 'working_hours', 'date_of_birth', 'hired_date', 'job_grade', 'employee_code', 'post_id', 'country'], 'required', 'on' => 'create'],
                        [['user_name', 'name', 'email', 'branch', 'department', 'designation', 'recommender', 'approver', 'working_hours', 'date_of_birth', 'hired_date', 'job_grade', 'employee_code', 'post_id', 'country'], 'required', 'on' => 'update'],
                        [['phone'], 'number'],
                        [['user_name',], 'unique', 'message' => 'Username must be unique.', 'on' => 'create'],
                        [['user_name'], 'unique', 'message' => 'Username must be unique.', 'on' => 'update'],
                        [['employee_code',], 'unique', 'message' => 'Employee Code must be unique.', 'on' => 'create'],
                        [['employee_code'], 'unique', 'message' => 'Employee Code must be unique.', 'on' => 'update'],
                        [['photo'], 'file', 'skipOnEmpty' => true, 'extensions' => 'png, jpg'],
                        [['email'], 'email'],
                        [['post_id', 'status', 'CB', 'UB', 'country'], 'integer'],
